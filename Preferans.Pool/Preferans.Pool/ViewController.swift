...
/*
 Task To DO
 1. Высчитать шаг ячейки для фона, в зависимости от типа устройства
 2. 
*/
...
class ViewController: UIViewController {
    ...
    private lazy var contentImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "reviews")
        return imageView
    }()
    
    // background will be more black
    ...
    private lazy var playerFirstButton: UIButton = {
        let button = UIButton()
        button.backgroundColor = UIColor.blue
        button.frame = CGRect(x: 20, y: 20, width: 200, height: 100)
        button.setTitle("Anton", for: .normal)
...
//        playerFirstButton.translatesAutoresizingMaskIntoConstraints = false
        popupView.addSubview(playerFirstButton)
    }
